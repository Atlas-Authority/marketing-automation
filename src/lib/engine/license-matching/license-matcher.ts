...
export class LicenseMatcher {
  ...
  public score(threshold: number, license1: License, license2: License, reasons: string[]): null | { item1: string, item2: string, score: number } {
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 80 + 30 + 30 + 30 + 30))) return earlyResult;
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 30 + 30 + 30 + 30))) return earlyResult;
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 30 + 30 + 30))) return earlyResult;
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 30 + 30))) return earlyResult;
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 30))) return earlyResult;
    ...
    if (false !== (earlyResult = basicallyDone(item1, item2, threshold, score, 0))) return earlyResult;
...
function basicallyDone(item1: string, item2: string, threshold: number, score: number, opportunities: number): false | null | { item1: string, item2: string, score: number } {
  if (score >= threshold) return { item1, item2, score: 999 };
