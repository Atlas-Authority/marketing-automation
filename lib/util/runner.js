 ...
 * @param {() => Promise<void>} options.normalizeData          Run once before `work()`.
 ...
 */
export default async function run({ normalizeData, work, failed }) {
  ...
  logger.info('Runner', 'Running data-normalization tasks');
  await normalizeData();
