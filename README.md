...
- Removed support for `HUBSPOT_API_KEY`; use `HUBSPOT_ACCESS_TOKEN` with [private apps](https://developers.hubspot.com/docs/api/migrate-an-api-key-integration-to-a-private-app) instead
